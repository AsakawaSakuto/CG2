...
void SphereData::Initialize(DirectXCommon* dxCommon) {
	dxCommon_ = dxCommon;
...
void SphereData::CreateRootSignature() {
...
void SphereData::InputLayoutSet() {
...
void SphereData::CompileShaders() {
...
void SphereData::RasiterzerStateSet() {
	// 裏面（時計回り）を表示しない
