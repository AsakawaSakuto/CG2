...
void TitleSceneUI::Initialize(AppContext* ctx) {
	...
	playUI_->Initialize(&ctx_->dxCommon, "resources/image/UI/title/playUI.png", { 640.0f,440.0f }, { 0.5f,0.5f });
	quitUI_->Initialize(&ctx_->dxCommon, "resources/image/UI/title/quitUI.png", { 640.0f,600.0f }, { 0.5f,0.5f });
	titleLogoUI_->Initialize(&ctx_->dxCommon, "resources/image/UI/title/titlelogo.png", { 640.0f,200.0f });
}
