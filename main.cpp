...
#pragma region RootParameterを作成 02_01 内容を1つ増やして追加 02_02 書き換える 03_00
	...
	// マテリアルにデータを書き込む
	VertexData* materialData = nullptr;
	// 書き込むためのアドレスを取得
...
#pragma region InputLayoutの設定を行う 02_00 InputLayoutの拡張 03_00
...
#pragma region VertexResourceを生成する 02_00

	ID3D12Resource* vertexResource = CreateBufferResource(device, sizeof(VertexData) * 3);

#pragma endregion

#pragma region VertexBufferViewを作成する VertexResourceにデータを書き込む 02_00
...
#pragma region TransformationMatrix用のResourceを作る 02_02
...
#pragma region メインループ開始前にtransform変数を作る 02_02
...
#pragma region Textureを読んで転送する 03_00
...
#pragma region ShaderResourceViewをつくる 03_00
